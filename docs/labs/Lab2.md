...
For example, if you select in the center pane the DNS of a Frame, the hexadecimal representation of that layer information should be highlighted in the bottom pane. Take a [screenshot](https://github.com/cs uob/COMS20012/blob/master/docs/materials/Screenshot%202023-02-05%20at%2023.08.42.png).
